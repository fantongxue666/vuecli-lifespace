  ...
  <div>
      ...
      <div id="list">
        <div class="box clearfix">
            ...
            <img class="head" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/1.jpg" alt=""/>
            <div class="content">
                <div class="main">
                    <p class="txt">
                        <span class="user">Andy：</span>轻轻的我走了，正如我轻轻的来；我轻轻的招手，作别西天的云彩。
                    </p>
                    <img class="pic" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/img1.jpg" alt=""/>
                </div>
                ...
                <div class="comment-list">
                    <div class="comment-box clearfix" user="self">
                        <img class="myhead" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/my.jpg" alt=""/>
        ...
        <div class="box clearfix">
            <a class="close" href="javascript:;">×</a>
            <img class="head" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/2.jpg" alt=""/>
            <div class="content">
                <div class="main">
                    <p class="txt">
                        <span class="user">人在旅途：</span>三亚的海滩很漂亮。
                    </p>
                    <img class="pic" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/img5.jpg" alt=""/>
                </div>
                <div class="info clearfix">
                    <span class="time">02-14 23:01</span>
                    <a class="praise" href="javascript:;">赞</a>
                ...
                <div class="comment-list">
                    <div class="comment-box clearfix" user="other">
                        <img class="myhead" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/4.jpg" alt=""/>
                        <div class="comment-content">
        ...
        <div class="box clearfix">
            <a class="close" href="javascript:;">×</a>
            <img class="head" src="https://www.17sucai.com/preview/639532/2016-10-25/54aa535f0001a6df00000000/images/3.jpg" alt=""/>
            <div class="content">
                <div class="main">
                    <p class="txt">
...
body { font-size: 12px; line-height: 120%; text-align: center; color:#333; padding: 20px;}
        ...
        * { margin: 0; padding: 0; border: none;}
        ...
        .info .praise { color: #369; float: right; height: 20px; padding-left: 18px; }
        .info .praise:hover { text-decoration: underline; }
        .praises-total { margin: 0 0 10px 0; height: 20px; padding: 5px 0 5px 25px; line-height: 19px;}
        ...
        .comment-box .comment-content .comment-praise { display: none; color: #369; padding-left: 17px; height: 20px;  position: absolute; bottom: 0px; right: 44px;}
